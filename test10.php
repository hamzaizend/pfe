...
$ok=$requete->rowCount();
if(!$ok){
    $_SESSION['flash']['danger']="Vous devez d'abbord passé et reussir le 1er test de la section General english";
    header('Location: course-general-english.php');
    exit();
}
...
if(isset($_POST['x1']) AND $_POST['c1'] == "2"){
  $score++;
}
if(isset($_POST['x2']) AND $_POST['c1'] == "1"){
  $score++;
}
if(isset($_POST['x3']) AND $_POST['c1'] == "2"){
  $score++;
}
if(isset($_POST['x4']) AND $_POST['c1'] == "2"){
  $score++;
}
if(isset($_POST['x5']) AND $_POST['c1'] == "2"){
  $score++;
}
if(isset($_POST['x6']) AND $_POST['c1'] == "1"){
  $score++;
}
...
if($score == 6){
  ...
  $insert->execute(array($_SESSION['id'],10,'Test Reussi'));
  $delete->execute(array('Test Pas Reussi',$_SESSION['id'],10));
  ...
  exit();
    ...
    $res_fail = "EMM Dommage , vous pouvez réessayer ";
      ...
      $find->execute(array($_SESSION['id'],10,'Test Pas Reussi'));
      $ok=$find->rowCount();
    if(!$ok){ 
      $insert=$bdd->prepare("INSERT INTO test(id_user,num,etat) VALUES(?,?,?)");
      $insert->execute(array($_SESSION['id'],10,'Test Pas Reussi'));
    ...
    $updatereq->execute(array($_SESSION['id'],10));
    $_SESSION['flash']['danger']=$res_fail ." <br> ".$resultat;
    }
  }
