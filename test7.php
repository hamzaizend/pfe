...
$requete->execute(array($_SESSION['id'],7,'Test Reussi'));
$ok=$requete->rowCount();
if($ok){
...
$ok=$requete->rowCount();
if(!$ok){
    $_SESSION['flash']['danger']="Vous devez d'abbord passé et reussir le 1er test de la section Skills";
    header('Location: course-details-skills.php');
    exit();
}
...
if(isset($_POST['submit'])){
  if(isset($_POST['c1']) && ( !isset($_POST['c3'])  || !isset($_POST['c5']) ) ){
    $score++;
}
if(isset($_POST['c2'])  && ( !isset($_POST['c3'])  || !isset($_POST['c5']) ) ){
  $score++;
}
if(isset($_POST['c4']) && ( !isset($_POST['c3'])  || !isset($_POST['c5']) ) ){
  $score++;
}
if(isset($_POST['c6']) && ( !isset($_POST['c3'])  || !isset($_POST['c5']) ) ){
  $score++;
}
...
if($score == 10){
    ...
    $insert->execute(array($_SESSION['id'],7,'Test Reussi'));
    $delete->execute(array('Test Pas Reussi',$_SESSION['id'],7));
    ...
    $res_fail = "EMM Dommage , vous pouvez réessayer ";
      ...
      $find->execute(array($_SESSION['id'],7,'Test Pas Reussi'));
      $ok=$find->rowCount();
    if(!$ok){ 
      $insert=$bdd->prepare("INSERT INTO test(id_user,num,etat) VALUES(?,?,?)");
      $insert->execute(array($_SESSION['id'],7,'Test Pas Reussi'));
    ...
    $updatereq->execute(array($_SESSION['id'],7));
    $_SESSION['flash']['danger']=$res_fail ." <br> ".$resultat;
    }
  }
...
<body>
  ...
  <?php if(isset($_SESSION['flash'])) : ?>
    ...
    <section class="course_details_area section_gap text-center">

        <h3> Writing : A message to say you're late - preparation : </h3>
        <h4 class="pt-3 pb-3">Choose the correct word.</h4>
        ...
        <form method="POST" action="">
            ...
            <br>
            <legend> <b> 1: </b> Thank you emails are always informal . </legend>
            ...
            <br>
            <legend> <b> 2 : </b> The first line shows what your email is about.</legend>
            ...
            <br>
            <legend> <b> 3 : </b> Use ‘Dear (+ name)’ if you know the person well.</legend>
            ...
            <br>
            <legend> <b> 4 : </b> Give examples of things you want to say thank you for. </legend>
            ...
            <br>
            <legend> <b> 5 : </b> Say ‘Keep in touch’ to mean you want to stay friends.</legend>
            ...
            <br>
            <br>
            <legend> <b> 6 : </b> When you make a joke, use the :( emoticon. </legend>
