...
$requete->execute(array($_SESSION['id'],8,'Test Reussi'));
$ok=$requete->rowCount();
if($ok){
...
$ok=$requete->rowCount();
if(!$ok){
    $_SESSION['flash']['danger']="Vous devez d'abbord passé et reussir le 2eme test de la section Skills";
    header('Location: course-details-skills.php');
    exit();
}
...
if($score == 6){
    ...
    $insert->execute(array($_SESSION['id'],8,'Test Reussi'));
    $delete->execute(array('Test Pas Reussi',$_SESSION['id'],8));
    ...
    $res_fail = "EMM Dommage , vous pouvez réessayer ";
      ...
      $find->execute(array($_SESSION['id'],8,'Test Pas Reussi'));
      $ok=$find->rowCount();
    if(!$ok){ 
      $insert=$bdd->prepare("INSERT INTO test(id_user,num,etat) VALUES(?,?,?)");
      $insert->execute(array($_SESSION['id'],8,'Test Pas Reussi'));
    ...
    $updatereq->execute(array($_SESSION['id'],8));
    $_SESSION['flash']['danger']=$res_fail ." <br> ".$resultat;
    }
  }
  ...
  <?php if(isset($_SESSION['flash'])) : ?>
    ...
    <section class="course_details_area section_gap text-center bg-light">
        ...
        <form method="POST" action="">
            ...
            <br>
            <legend> <b> 1 : </b> The team meeting will be in the evening. </legend>
            ...
            <br>
            <legend> <b> 2 : </b> There will be people from different countries at the meeting.</legend>
            ...
            <br>
            <legend> <b> 3 : </b> Amelia has already booked Room 310 for Friday 26 November.</legend>
            ...
            <br>
            <legend> <b> 4 : </b> Amelia wants Tim to get 25 pens and notepads ready for the meeting. </legend>
            ...
            <br>
            <legend> <b> 5 : </b> Amelia wants Tim to email the 25 team members.</legend>
            ...
            <br>
            <br>
            <legend> <b> 6 : </b> If Tim has any questions, he can ask Amelia tomorrow morning.</legend>
