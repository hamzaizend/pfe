...
$ok=$requete->rowCount();
if(!$ok){
    $_SESSION['flash']['danger']="Vous devez d'abbord passé et reussir le 2eme test de la section grammar";
    header('Location: course-details-grammar.php');
    exit();
}
...
$score=0;
          ...
          if(isset($_POST['submit'])) {
            ...
            if($score == 8){
                ...
                $insert->execute(array($_SESSION['id'],3,'Test Reussi'));
                $delete->execute(array('Test Pas Reussi',$_SESSION['id'],3));
                ...
                $res_fail = "EMM Dommage , vous pouvez réessayer ";
                  ...
                  $find->execute(array($_SESSION['id'],3,'Test Pas Reussi'));
                  $ok=$find->rowCount();
                if(!$ok){ 
                  $insert=$bdd->prepare("INSERT INTO test(id_user,num,etat) VALUES(?,?,?)");
                  $insert->execute(array($_SESSION['id'],3,'Test Pas Reussi'));
                ...
                $updatereq->execute(array($_SESSION['id'],3));
                $_SESSION['flash']['danger']=$res_fail ." <br> ".$resultat;
                }
              }
    ...
    <section class="course_details_area section_gap bg-light text-center">
        ...
        <div class="container border border-dark rounded p-2">
            <div class="text-center lead ">
                <h2 class="lead ">* Complete the sentences with <b>'a'</b>, <b>'an'</b> or <b>'the'</b>, or <b>'-'</b>
                    if no article is needed. * </h2><br />

                    <form method="POST" action="">
                        <p> <b> 1 : </b> I like listening to <input type="text" name="text1" value="<?php if(isset($text1)){
  echo $text1; }?>" class="check003" size="5" /><text class="button002"></text> music, it helps me relax
                            .<?php if(isset($resultat1)) echo $resultat1; ?><br> <br>

                            <b> 2 : </b> <input id="input002" size="5" name="text2" value="<?php if(isset($text2)){
  echo $text2; }?>" /><text class="button002" id="check002"></text> money he gave me wasn't enough .
                            <?php if(isset($resultat2))echo $resultat2; ?><br><br>

                            <b> 3 : </b> He doesn't like <input id="input003" size="5" name="text3" value="<?php if(isset($text3)){
  echo $text3; }?>" /> <text class="button002" id="check003"></text> dogs. One bit him when he was a child .
                            <?php if(isset($resultat3)) echo $resultat3; ?><br><br>

                            <b> 4 : </b> Could you please pass me <input id="input004" size="5" value="<?php if(isset($text4)){
  echo $text4; }?>" name="text4" /><text class="button002" id="check004"></text> salt ?
                            <?php if(isset($resultat4)) echo $resultat4; ?><br><br>

                            <b> 5 : </b> Do you want <input id="input005" value="<?php if(isset($text5)){
  echo $text5; }?>" size="5" name="text5" /><text class="button002" id="check005"></text> apple ? I've got two in my
                            bag . <?php if(isset($resultat5)) echo $resultat5; ?><br><br>


                            <b> 6 : </b> I can take <input type="text" value="<?php if(isset($text6)){
  echo $text6; }?>" name="text6" id="input006" size="5" /><text class="button002" id="check006"></text> children to
                            school today . <?php if(isset($resultat6)) echo $resultat6; ?><br>
                            <br>

                            <b> 7 : </b> This is my uncle Phil . He's <input type="text" value="<?php if(isset($text7)){
  echo $text7; }?>" name="text7" id="input007" size="5" /><text class="button002" id="check007"></text> teacher and he
                            lives in London . <?php if(isset($resultat7)) echo $resultat7; ?><br><br>

                            <b> 8 : </b> Is there <input id="input008" name="text8" size="5" value="<?php if(isset($text8)){
  echo $text8; }?>" /><text class="button002" id="check008"></text> university where you live ?
                            <?php if(isset($resultat8)) echo $resultat8; ?>
                        ...
                        <br>
                        <div id="disappear001">
                            <div id="center001"><button class="btn btn-outline-dark pl-5 pr-5"
                                    name="submit">Submit</button>
                                    <button class="btn btn-outline-dark pl-5 pr-5" type="reset">Try again </button>
                                    </div>
                        </div><br />
                    </form>
